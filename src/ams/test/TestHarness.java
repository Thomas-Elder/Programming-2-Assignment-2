...
/**
 * <b>COSC 2136, Adv Prog Techniques / Programming 2, Assignment 1</b><br/>
 * 
...
public class TestHarness {
	...
	public static boolean test2() throws Exception {
		...
		try {
			...
			System.out.println(model.countCoreCourses() + " CORE");
			System.out.println(model.countElectiveCourses() + " ELECTIVES");
	...
	public static boolean test3() throws Exception {
		...
		try {
			...
			if (model.getAllCourses() != null) {
				System.out.println("model.getAllCourses() != null");
				return false;
			}
	...
	public static boolean test11() throws Exception {
		...
		try {
			...
			try {
				...
				model.enrollIntoCourse(P1);	
				System.out.println("Enrolling student into the same core course...");
				model.enrollIntoCourse(P1);	
			} catch (EnrollmentException e) {
				System.out.println(e.getMessage() + "  correct");
				flag ++;
			...
			try {
				...
				model.enrollIntoCourse(MAD);	
				System.out.println("Enrolling student into the same elective course...");
				model.enrollIntoCourse(MAD);	
			} catch (EnrollmentException e) {
				System.out.println(e.getMessage() + "  correct");
				flag++;
	...
	public static boolean test13() throws Exception {
		...
		try {			
			...
			try {
				System.out.println("Enrolling student into another elective course and causing overload...");
				model.enrollIntoCourse(MAD);	
			} catch (EnrollmentException e) {
				System.out.println(e.getMessage() + "  correct");
				flag++;
			...
			// exception should NOT be thrown due to overload since there are no failed courses
			try {
				System.out.println("Enrolling student into another elective course...");
				model.enrollIntoCourse(MAD);	
			} catch (EnrollmentException e) {
				System.out.println(e.getMessage() + "  correct");
				return false;
			...
			model.enrollIntoCourse(P2);
			System.out.println("Adding FAIL result for the third enrolled course...");
			...
			// exception should NOT be thrown because one of the prereqs was passed 
			try {
				System.out.println("Enrolling student into fourth core course...");				
				model.enrollIntoCourse(COMP_THEORY);
			} catch (EnrollmentException e) {
	...
	public static void test14() {		
		...
		int[] testMarks = {7, 8, 7, 10, 10, 5, 8, 8, 7, 7, 3, 10, 10};
